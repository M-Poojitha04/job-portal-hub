    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4">
            <div className="max-w-2xl w-full bg-white p-8 rounded-2xl shadow-xl border border-slate-200">
                ...
                {error && <div className="mb-4 p-3 bg-red-50 text-red-600 font-semibold rounded-xl text-sm border border-red-200">{error}</div>}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select value={formData.jobType} onChange={e => setFormData({...formData, jobType: e.target.value})} className="w-full px-4 py-2.5 border border-slate-200 rounded-xl outline-none bg-white focus:border-blue-500 font-semibold text-slate-700">
